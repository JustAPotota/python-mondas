...
class Point3(_message.Message):
    ...
    z: float
    d: float
    def __init__(self, x: _Optional[float] = ..., y: _Optional[float] = ..., z: _Optional[float] = ..., d: _Optional[float] = ...) -> None: ...
...
class Transform(_message.Message):
    ...
    translation: Vector3
    scale: Vector3
    def __init__(self, rotation: _Optional[_Union[Quat, _Mapping]] = ..., translation: _Optional[_Union[Vector3, _Mapping]] = ..., scale: _Optional[_Union[Vector3, _Mapping]] = ...) -> None: ...
